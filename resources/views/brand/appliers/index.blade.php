                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="display:flex; justify-content:end;">
                            ...
                            <a class="btn btn-primary btn-xs" title="View Post" style="margin-left: 8px;" href="{{route('brand.campaign.influencerPortfolio')}}/{{$data->userId}}"><i class="menu-icon fa fa-eye text-white fa-lg"></i></a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
