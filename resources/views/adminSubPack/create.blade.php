...
<div class="box-content card danger">
    ...
    <div class="" style="padding: 12px 10px 12px 10px; display: flex; justify-content: space-between; background-color: #03ACF0; color:white;">
        <div class="">
            <h4 class="">Create Subscription Package</h4>
        </div>
        <div class="">
    ...
    <div class="card-content">
        ...
        <form action="{{route('adminsubscriptionpackage.store')}}" class="was-validated" novalidate method="post" style="margin-top:15px;">
            @csrf
            ...
            <div class="mb-3">
                ...
                <textarea name="details" id="details" class="form-control" cols="10" rows="5" required></textarea>
            </div>
            <br>
