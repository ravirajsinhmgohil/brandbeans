...
@section('content')
    ...
    <div class="box-content card danger">
        ...
        <div class="" style="padding: 12px 10px 12px 10px; display: flex; justify-content: space-between; background-color: #03ACF0; color:white;">
            ...
            <div class="">
                <a href="{{ route('userTemplate.index') }}" class="btn btnback btn-sm" style="background-color: #002E6E; color:white;">BACK</a>
                <!-- /.sub-menu -->
            </div>
        </div>
        ...
        <div class="card-content">
            ...
            <form action="{{ route('userTemplate.store') }}" enctype="multipart/form-data" class="was-validated" novalidate method="post" style="margin-top: 15px;">
                @csrf
