...
<body>
    <div id="single-wrapper">
        <div class="w-50">
            <form action="{{route('auth.loginotp')}}" method="post" class="frm-single">
                @csrf
                ...
                <div class="inside">
                    ...
                    @endif
                    <!-- /.title -->
                    <div class="frm-title">Check Otp</div>

                    <!-- /.frm-title -->
                    <div class="frm-input" style="width: 90%;">
                        <input type="text" class="frm-inp @error('otp') is-invalid @enderror" value="{{ old('otp') }}" id="otp" name="otp" required autocomplete="otp" autofocus placeholder="Enter OTP here"><i class="fa fa-phone frm-ico"></i>
                        @error('otp')
