            ...
            <div class="navigation ">
                ...
                <ul class="menu js__accordion">
                    ...
                    <<<<<<< HEAD=======@role('Reseller') <li>
                        ...
                        <!-- reseller -->
                        <li>
                            <a class="text-white waves-effect parent-item js__control" href="#"><i class="text-white menu-icon fa fa-sellsy"></i><span>Reseller</span><span class="menu-arrow fa fa-angle-down"></span></a>
                            <ul class="sub-menu js__content ">
                                <li>
                                    <a class="text-white waves-effect" href="{{route('reseller.index')}}"><span>View</span></a>
                                </li>
                            </ul>
                        </li>
                        <!-- template -->
