...
<div class="box-content card">
    ...
    <div class="card-content">
        <form action="{{route('story.store')}}" enctype="multipart/form-data" class="was-validated" method="post">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control fs-4" id="description" name="description"></textarea>
            </div>
            <br>
