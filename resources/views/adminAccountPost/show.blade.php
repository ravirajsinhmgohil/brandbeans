                    ...
                    <div class="box-content card danger">
                        ...
                        <div class="card-content">
                            <div class="row">
                                ...
                                @else
                                    <div class="col-md-7">
                                        <h5 style="color: #002e6e;">Company Name : <span class="text-dark">-</span></h5>
                                        <h5 style="color: #002e6e;">Heading : <span class="text-dark">-</span></h5>
                                        <h5 style="color: #002e6e;">Category : <span class="text-dark">-</span></h5>
                                        <h5 style="color: #002e6e;">City : <span class="text-dark">-</span></h5>
                                        <h5 style="color: #002e6e;">State : <span class="text-dark">-</span></h5>
                                        <h5 style="color: #002e6e;">Year : <span class="text-dark">-</span></h5>
                                        <h5 style="color: #002e6e;">About : <span class="text-dark">-</span></h5>
                                    </div>
                                    <div class="col-md-5">
