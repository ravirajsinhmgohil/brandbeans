                                    ...
                                    @foreach ($data as $user1)
                                        ...
                                        <div class="row my-3 ">
                                            <div class="col">
                                                ...
                                                <a class="" href="{{ route('demo_edit') }}/{{ $user1->id }}" id="show-user"><button type="button" class="butt btn btn-light"><i class="bi bi-pencil"></i><span class="m-1">Edit</span></button></a>
                                            </div>
                                            <div class="col">
